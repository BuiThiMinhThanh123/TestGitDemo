<%-- 
    Document   : home
    Created on : May 10, 2024, 9:10:38 AM
    Author     : thanh
--%>
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="home.jsp" class="item-anchor active d-flex align-item-center" data-effect="Home">Home<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="home.jsp" class="item-anchor active">Home</a></li>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="btn-wrap">
                      <a href="shop.jsp" class="btn btn-light btn-medium d-flex align-items-center" tabindex="0">Shop it now <i class="icon icon-arrow-io"></i>
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu feugiat amet, libero ipsum enim pharetra hac.</p>
                    <div class="btn-wrap">
                      <a href="shop.jsp" class="btn btn-light btn-light-arrow btn-medium d-flex align-items-center" tabindex="0">Shop it now <i class="icon icon-arrow-io"></i>
                      </a>
                    </div>
                  </div>
                </div>
    ...
    <section id="featured-products" class="product-store padding-large">
      <div class="container">
        <div class="section-header d-flex flex-wrap align-items-center justify-content-between">
          ...
          <div class="btn-wrap">
            <a href="shop.jsp" class="d-flex align-items-center">View all products <i class="icon icon icon-arrow-io"></i></a>
          </div>            
        </div>
          ...
          <div class="col-lg-7 col-md-12 left-content">
            <div class="collection-item">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 product-entry">
                ...
                <div class="btn-wrap">
                  <a href="shop.jsp" class="d-flex align-items-center">shop collection <i class="icon icon-arrow-io"></i>
                  </a>
                </div>
              </div>
            </div>
    ...
    <section id="selling-products" class="product-store bg-light-grey padding-large">
      <div class="container">
        ...
        <ul class="tabs list-unstyled">
          ...
          <li data-tab-target="#shirts" class="tab">Shirts</li>
