<%-- 
    Document   : blog
    Created on : May 10, 2024, 10:09:03 AM
    Author     : thanh
--%>
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="shop.jsp" class="item-anchor d-flex align-item-center" data-effect="Home">Home<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="shop.jsp" class="item-anchor">Home</a></li>
                        </ul>
                      </li>
                      ...
                      <li class="menu-item has-sub">
                        <a href="blog.jsp" class="item-anchor active d-flex align-item-center" data-effect="Blog">Blog<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="blog.jsp" class="item-anchor active">Blog</a></li>
                        </ul>
                      </li>
