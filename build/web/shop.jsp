<%-- 
    Document   : shop
    Created on : May 10, 2024, 9:53:22 AM
    Author     : thanh
--%>
                ...
                <div class="navbar">
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="shop.jsp" class="item-anchor active d-flex align-item-center" data-effect="Shop">Shop<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="shop.jsp" class="item-anchor active">Shop</a></li>
                        </ul>
                      </li>
