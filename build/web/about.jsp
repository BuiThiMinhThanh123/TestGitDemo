<%-- 
    Document   : about
    Created on : May 10, 2024, 9:16:16 AM
    Author     : thanh
--%>
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="home.jsp" class="item-anchor d-flex align-item-center" data-effect="Home">Home<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="home.jsp" class="item-anchor">Home</a></li>
                          
                        </ul>
                      </li>

                      <li><a href="about.jsp" class="item-anchor active" data-effect="About">About</a></li>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="detail">
              <div class="display-header">
                ...
                <div class="btn-wrap">
                  <a href="shop.jsp" class="btn btn-dark btn-medium d-flex align-items-center" tabindex="0">Shop our store<i class="icon icon-arrow-io"></i>
                  </a>
                </div>
              </div>
            </div>
